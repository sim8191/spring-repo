        ...
        <div class="list-group-row flex-wrap row">
           <article class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a class="text-dark" href="detail">안보는 책 팝니다</a></h5><!-- detail/2 -> detail -->
            ...
            <article class="col-md-4">
                <div class="card mb-4">
                    <img src="/study/resources/upload/study/2.png" class="card-img-top thumbnail" alt="Image 2">
                    <div class="card-body">
                        <h5 class="card-title"><a class="text-dark" href="detail">스터디 같이 하실 분</a></h5><!-- detail/1 -> detail -->
                        <p class="card-text">모집중(3/5)</p>
                        <small class="text-muted">작성자: KH 수달 | 작성일: 2024-06-17</small>
                    </div>
                </div>
